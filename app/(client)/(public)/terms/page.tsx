  ...
  const termsData = [
    {
      ...
      icon: CheckCircle2,
      content: [
        "By accessing and using EcoTech Solutions&apos;s website and services, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service.",
        "These terms constitute a legally binding agreement between you and EcoTech Solutions. If you do not agree with any part of these terms, you must not use our services.",
    ...
    },
    {
      ...
      icon: FileText,
      content: [
        "All content, trademarks, logos, and intellectual property on our website are owned by EcoTech Solutions or our licensors and are protected by copyright and trademark laws.",
          ...
          <div className="text-center">
            <div className="flex items-center justify-center gap-2 mb-4">
              ...
              <p className="text-sm text-light-text">
                These terms were last updated on January 15, 2025
              </p>
            </div>
            <p className="text-xs text-light-text">
              By continuing to use our platform, you agree to the most current
