        ...
        <Container className="max-w-6xl">
          ...
          >
            ...
            <p className="text-xl lg:text-2xl text-white/90 max-w-3xl mx-auto leading-relaxed">
              Have questions about our products or need assistance? We look foward
              to hear from you. Our team is here to help with any inquiries
              you may have.
            </p>
          </motion.div>
        </Container>
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-dark-text max-w-xl mx-auto">
              Find helpful answers to common questions about our services and
              policies.
            </p>
          </div>
            ...
            {[
              {
                ...
                a: "We offer free shipping on orders over KSh 5000 within Nairobi. Shipping outside Nairobi is available with additional charges.",
              },
              {
              ...
              },
              {
                ...
                a: "Yes! Our customer service team is available Monday-Friday 9AM-7PM via phone, email, or live chat.",
              },
            ].map((faq, index) => (
              <div
                key={index}
