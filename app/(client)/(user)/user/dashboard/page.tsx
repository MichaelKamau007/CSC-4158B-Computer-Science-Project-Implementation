...
export default function UserDashboardPage() {
  ...
  useEffect(() => {
    if (isLoaded && !user) {
      router.push("/sign-in?redirectTo=/user/dashboard");
    }
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-8">
        ...
        {userProfile &&
          ...
          !userProfile.isBusiness && (
            <div className="mb-6 p-6 bg-linear-to-rrom-green-50 to-emerald-50 border-l-4 border-green-400 rounded-lg shadow-sm">
              <div className="flex items-start gap-4">
                <div className="shrink-0">
        ...
        {userProfile && userProfile.businessStatus === "pending" && (
          <div className="mb-6 p-6 bg-linear-to-rrom-blue-50 to-indigo-50 border-l-4 border-blue-400 rounded-lg shadow-sm">
            <div className="flex items-start gap-4">
              <div className="shrink-0">
