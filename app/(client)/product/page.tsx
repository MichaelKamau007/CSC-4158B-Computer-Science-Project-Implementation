          ...
          <div className="py-16 text-white"> 
            ...
            <div className="max-w-3xl">
              ...
              <p className="text-lg md:text-xl text-white/90 leading-relaxed mb-8">
                ...
                cutting-edge refurbished electronics to stylish accessories, find everything
        ...
        <Container>
          <div className="py-12 text-center">
            ...
            <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
              Our customer support team is here to help you find the ideal product. Get in touch with us for personalized recommendations.
            </p>
