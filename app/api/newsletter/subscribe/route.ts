...
export async function POST(request: NextRequest) {
  try {
    ...
    const emailResult = await sendMail({
      email,
      subject: "Welcome to EcoTech Solutions Newsletter! 🎉",
...
<head>
    ...
    <title>Welcome to EcoTech Solutions Newsletter</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="welcome-message">
                ...
                <p>
                    Thank you for subscribing to the EcoTech Solutions newsletter! We're thrilled to have you as part of our community. 
        ...
        <div class="footer">
            ...
            <p>
                ...
                <a href="mailto:support@ecotech.com">support@ecotech.com</a> or 
            ...
            <div class="unsubscribe">
                <p>
                    You received this email because you subscribed to EcoTech Solutions Newsletter with ${email}.<br>
                    <a href="${
