...
const SignUpPage = () => {
  ...
  const benefits = [
    ...
    },
    {
      icon: Truck,
      title: "Free Shipping",
      description: "Enjoy free shipping on orders over KSh 5000",
    },
    {
      icon: CreditCard,
  ...
  useEffect(() => {
    if (isLoaded && isSignedIn) {
      const destination = redirectTo || "/user/dashboard";
  ...
  if (!isLoaded) {
    return (
      <div className="min-h-screen bg-linear-to-br from-shop_orange/5 via-shop_light_bg to-shop_light_pink/60 flex items-center justify-center">
  ...
  // If already signed in, show loading while redirecting (don't render SignUp component)
  if (isSignedIn) {
    return (
      <div className="min-h-screen bg-linear-to-br from-shop_orange/5 via-shop_light_bg to-shop_light_pink/60 flex items-center justify-center">
        <div className="text-center">
