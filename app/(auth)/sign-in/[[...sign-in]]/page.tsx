...
const SignInPage = () => {
  ...
  if (!isLoaded) {
    return (
      <div className="min-h-screen bg-linear-to-br from-shop_light_green/5 via-shop_light_bg to-shop_light_pink/50 flex items-center justify-center">
  ...
  // If already signed in, show loading while redirecting (don't render SignIn component)
  if (isSignedIn) {
    return (
      <div className="min-h-screen bg-linear-to-br from-shop_light_green/5 via-shop_light_bg to-shop_light_pink/50 flex items-center justify-center">
        <div className="text-center">
