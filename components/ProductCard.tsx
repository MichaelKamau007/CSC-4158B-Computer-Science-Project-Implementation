  ...
  return (
    <div className="text-sm border rounded-md border-dark-blue/20 group bg-white">
      <div className="relative group overflow-hidden bg-shop_light_bg">
        ...
        {product?.status === "sale" ? (
          <p className="absolute top-2 left-2 z-10 text-xs bg-white border border-dark-color/50 px-2 rounded-full group-hover:border-light-green hover:text-shop_dark_green hoverEffect">
