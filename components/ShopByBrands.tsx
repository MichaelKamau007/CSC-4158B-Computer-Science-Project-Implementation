...
const extraData = [
  {
    title: "Free Delivery",
    description: "Free shipping for items over KSh 5000",
    icon: <Truck size={45} />,
  },
  {
    title: "Return Policy",
    description: "For unsatisfactory electronic items",
  ...
  },
  {
    ...
    description: "Money back guarantee for purchased products",
