...
```bash
NEXT_PUBLIC_COMPANY_NAME=Ecotech Solutions                # Your company name
NEXT_PUBLIC_COMPANY_EMAIL=support@ecotech.com             # Main company email
NEXT_PUBLIC_COMPANY_PHONE=+254712345678                   # Main phone number
...
```bash
NEXT_PUBLIC_SUPPORT_EMAIL=support@ecotech.com             # Customer support email
NEXT_PUBLIC_SALES_EMAIL=sales@ecotech.com                 # Sales team email
```
...
```bash
NEXT_PUBLIC_FACEBOOK_URL=https://facebook.com/ecotech
NEXT_PUBLIC_TWITTER_URL=https://twitter.com/ecotech
NEXT_PUBLIC_INSTAGRAM_URL=https://instagram.com/ecotech
...
1. Update `NEXT_PUBLIC_COMPANY_PHONE=+254712345678` in `.env`
