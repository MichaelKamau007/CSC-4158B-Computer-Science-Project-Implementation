...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <p>Thank you for shopping with EcoTech Solutions</p>
        </div>
    ...
    data.shippingAddress.state
        ...
        <!-- Footer -->
        <div class="footer">
            <p><strong>EcoTech Solutions</strong></p>
            <p>123 Shopping Street, Commerce District<br>
               Nairobi, Kenya</p>
            <p>Thank you for choosing EcoTech Solutions!</p>
            
            <div class="social-links">
                <a href="https://www.facebook.com">Facebook</a> |
                <a href="https://www.twitter.com">Twitter</a> |
                <a href="https://www.instagram.com">Instagram</a> |
                <a href="https://www.ecotech.com">Support</a>
            </div>
        </div>
    </div>
</body>
...
const sendOrderConfirmationEmail = async (
  ...
  try {
    ...
    const { data: emailData, error } = await resend.emails.send({
      from: process.env.SENDER_EMAIL_ADDRESS || "onboarding@resend.dev",
...
If you have any questions, please contact us at support@ecotech.com or +254712345678.

Thank you for choosing EcoTech Solutions!
      `,
    });
